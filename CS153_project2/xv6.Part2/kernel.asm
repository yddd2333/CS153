...
801009f6:	81 ec 0c 01 00 00    	sub    $0x10c,%esp
  uint argc, sz, sp, se, ustack[3+MAXARG+1];// cs153
  struct elfhdr elf;
  struct inode *ip;
  struct proghdr ph;
...
80100b6f:	e8 3c 20 00 00       	call   80102bb0 <end_op>
  ...
  sz = PGROUNDUP(sz);
  sp = PGROUNDDOWN(KERNBASE-4);
  if((sp = allocuvm(pgdir, sp-PGSIZE, sp)) == 0)// Stack pointer to top of stack cs153
80100b74:	83 c4 0c             	add    $0xc,%esp
80100b77:	68 00 f0 ff 7f       	push   $0x7ffff000
80100b7c:	68 00 e0 ff 7f       	push   $0x7fffe000
80100b81:	ff b5 f0 fe ff ff    	pushl  -0x110(%ebp)
80100b87:	e8 54 5f 00 00       	call   80106ae0 <allocuvm>
80100b8c:	83 c4 10             	add    $0x10,%esp
80100b8f:	85 c0                	test   %eax,%eax
80100b91:	89 c6                	mov    %eax,%esi
80100b93:	74 7e                	je     80100c13 <exec+0x223>
    goto bad;// Allocate one page under KERNBASE cs153
  se = sp-PGSIZE;// This points to bottom page of stack cs153

  // Push argument strings, prepare rest of stack in ustack.
  for(argc = 0; argv[argc]; argc++) {
80100b95:	8b 45 0c             	mov    0xc(%ebp),%eax
80100b98:	31 ff                	xor    %edi,%edi
80100b9a:	89 f3                	mov    %esi,%ebx
80100b9c:	8d 95 58 ff ff ff    	lea    -0xa8(%ebp),%edx
80100ba2:	8b 00                	mov    (%eax),%eax
80100ba4:	85 c0                	test   %eax,%eax
80100ba6:	0f 84 a7 00 00 00    	je     80100c53 <exec+0x263>
80100bac:	89 b5 e8 fe ff ff    	mov    %esi,-0x118(%ebp)
80100bb2:	8b b5 f0 fe ff ff    	mov    -0x110(%ebp),%esi
80100bb8:	eb 25                	jmp    80100bdf <exec+0x1ef>
80100bba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
80100be3:	e8 58 3a 00 00       	call   80104640 <strlen>
...
80100bf6:	e8 45 3a 00 00       	call   80104640 <strlen>
...
80100c07:	e8 24 63 00 00       	call   80106f30 <copyout>
...
80100c1c:	e8 ef 5f 00 00       	call   80106c10 <freevm>
...
80100c29:	e9 2e fe ff ff       	jmp    80100a5c <exec+0x6c>
  ...
  if((ip = namei(path)) == 0){
    end_op();
80100c2e:	e8 7d 1f 00 00       	call   80102bb0 <end_op>
    cprintf("exec: fail\n");
80100c33:	83 ec 0c             	sub    $0xc,%esp
80100c36:	68 e1 70 10 80       	push   $0x801070e1
...
80100c4d:	8b b5 e8 fe ff ff    	mov    -0x118(%ebp),%esi
  }
  ustack[3+argc] = 0;
...
80100c87:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c8d:	e8 9e 62 00 00       	call   80106f30 <copyout>
...
80100cc9:	83 ec 04             	sub    $0x4,%esp
  ...
  curproc->pgdir = pgdir;
  curproc->sz = sz;// The top of heap cs153
  curproc->se = se;// Bottom end page of stack cs153
80100ccc:	81 ee 00 10 00 00    	sub    $0x1000,%esi
  ...
  for(last=s=path; *s; s++)
    if(*s == '/')
      last = s+1;
  safestrcpy(curproc->name, last, sizeof(curproc->name));
80100cd2:	6a 10                	push   $0x10
80100cd4:	ff 75 08             	pushl  0x8(%ebp)
80100cd7:	89 f8                	mov    %edi,%eax
80100cd9:	83 c0 70             	add    $0x70,%eax
80100cdc:	50                   	push   %eax
80100cdd:	e8 1e 39 00 00       	call   80104600 <safestrcpy>
  end_op();
  ip = 0;
...
80100ce8:	8b 95 f0 fe ff ff    	mov    -0x110(%ebp),%edx
  ...
  // Commit to the user image.
  oldpgdir = curproc->pgdir;
80100cee:	89 f9                	mov    %edi,%ecx
80100cf0:	8b 7f 08             	mov    0x8(%edi),%edi
  curproc->pgdir = pgdir;
  curproc->sz = sz;// The top of heap cs153
  curproc->se = se;// Bottom end page of stack cs153
80100cf3:	89 71 04             	mov    %esi,0x4(%ecx)
  end_op();
  ip = 0;
  ...
  // Make the first inaccessible.  Use the second as the user stack.
  sz = PGROUNDUP(sz);
80100cf6:	05 ff 0f 00 00       	add    $0xfff,%eax
      last = s+1;
  safestrcpy(curproc->name, last, sizeof(curproc->name));
  ...
  oldpgdir = curproc->pgdir;
  curproc->pgdir = pgdir;
80100cfb:	89 51 08             	mov    %edx,0x8(%ecx)
  curproc->sz = sz;// The top of heap cs153
80100cfe:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80100d03:	89 01                	mov    %eax,(%ecx)
  curproc->se = se;// Bottom end page of stack cs153
  curproc->tf->eip = elf.entry;  // main
80100d05:	8b 41 1c             	mov    0x1c(%ecx),%eax
80100d08:	8b 95 3c ff ff ff    	mov    -0xc4(%ebp),%edx
80100d0e:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100d11:	8b 41 1c             	mov    0x1c(%ecx),%eax
80100d14:	89 58 44             	mov    %ebx,0x44(%eax)
  switchuvm(curproc);
80100d17:	89 0c 24             	mov    %ecx,(%esp)
80100d1a:	e8 71 5b 00 00       	call   80106890 <switchuvm>
  freevm(oldpgdir);
80100d1f:	89 3c 24             	mov    %edi,(%esp)
80100d22:	e8 e9 5e 00 00       	call   80106c10 <freevm>
  return 0;
80100d27:	83 c4 10             	add    $0x10,%esp
80100d2a:	31 c0                	xor    %eax,%eax
80100d2c:	e9 2b fd ff ff       	jmp    80100a5c <exec+0x6c>
80100d31:	66 90                	xchg   %ax,%ax
...
801010d4:	68 0f 71 10 80       	push   $0x8010710f
...
801010e1:	68 15 71 10 80       	push   $0x80107115
...
80101192:	68 1f 71 10 80       	push   $0x8010711f
...
801012c4:	68 35 71 10 80       	push   $0x80107135
...
8010138a:	68 45 71 10 80       	push   $0x80107145
...
80101456:	68 58 71 10 80       	push   $0x80107158
...
80101c5e:	83 ec 0c             	sub    $0xc,%esp
  ...
  if(*path == '/')
    ...
    ip = idup(myproc()->cwd);
80101c61:	8b 70 6c             	mov    0x6c(%eax),%esi
// Increment reference count for ip.
// Returns ip to enable ip = idup(ip1) idiom.
struct inode*
idup(struct inode *ip)
...
80102ea3:	e8 28 41 00 00       	call   80106fd0 <shminit>
  tvinit();        // trap vectors
...
801033d5:	8b 48 28             	mov    0x28(%eax),%ecx
...
801034ee:	8b 48 28             	mov    0x28(%eax),%ecx
...
801035c9:	74 75                	je     80103640 <allocproc+0xa0>
    if(p->state == UNUSED)
801035cb:	8b 43 10             	mov    0x10(%ebx),%eax
...
found:
  p->state = EMBRYO;
801035da:	c7 43 10 01 00 00 00 	movl   $0x1,0x10(%ebx)
  p->pid = nextpid++;
...
801035e9:	89 43 14             	mov    %eax,0x14(%ebx)
...
80103601:	89 43 0c             	mov    %eax,0xc(%ebx)
...
8010360f:	05 9c 0f 00 00       	add    $0xf9c,%eax
  ...
  // Leave room for trap frame.
  sp -= sizeof *p->tf;
80103614:	89 53 1c             	mov    %edx,0x1c(%ebx)
...
80103622:	50                   	push   %eax
  ...
  *(uint*)sp = (uint)trapret;
  ...
  sp -= sizeof *p->context;
  p->context = (struct context*)sp;
80103623:	89 43 20             	mov    %eax,0x20(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103626:	e8 d5 0d 00 00       	call   80104400 <memset>
  p->context->eip = (uint)forkret;
8010362b:	8b 43 20             	mov    0x20(%ebx),%eax
...
80103656:	c3                   	ret    
  ...
  if((p->kstack = kalloc()) == 0){
    p->state = UNUSED;
80103657:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
    return 0;
...
801036b6:	68 b5 75 10 80       	push   $0x801075b5
...
8010372d:	68 bc 75 10 80       	push   $0x801075bc
...
8010373a:	68 98 76 10 80       	push   $0x80107698
...
801037ba:	89 43 08             	mov    %eax,0x8(%ebx)
...
801037e3:	ff 73 1c             	pushl  0x1c(%ebx)
...
80103833:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  ...
  safestrcpy(p->name, "initcode", sizeof(p->name));
8010383a:	8d 43 70             	lea    0x70(%ebx),%eax
8010383d:	6a 10                	push   $0x10
8010383f:	68 e5 75 10 80       	push   $0x801075e5
80103844:	50                   	push   %eax
80103845:	e8 b6 0d 00 00       	call   80104600 <safestrcpy>
  p->cwd = namei("/");
8010384a:	c7 04 24 ee 75 10 80 	movl   $0x801075ee,(%esp)
80103851:	e8 5a e6 ff ff       	call   80101eb0 <namei>
80103856:	89 43 6c             	mov    %eax,0x6c(%ebx)
...
80103860:	e8 2b 0a 00 00       	call   80104290 <acquire>
  ...
  p->state = RUNNABLE;
80103865:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
...
80103883:	68 cc 75 10 80       	push   $0x801075cc
...
801038bb:	ff 73 08             	pushl  0x8(%ebx)
...
801038f1:	ff 73 08             	pushl  0x8(%ebx)
...
8010393a:	0f 84 bd 00 00 00    	je     801039fd <fork+0xed>
  ...
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz, curproc->se)) == 0){
80103940:	83 ec 04             	sub    $0x4,%esp
80103943:	ff 73 04             	pushl  0x4(%ebx)
80103946:	ff 33                	pushl  (%ebx)
80103948:	ff 73 08             	pushl  0x8(%ebx)
8010394b:	e8 10 34 00 00       	call   80106d60 <copyuvm>
80103950:	83 c4 10             	add    $0x10,%esp
80103953:	85 c0                	test   %eax,%eax
80103955:	89 47 08             	mov    %eax,0x8(%edi)
80103958:	0f 84 a6 00 00 00    	je     80103a04 <fork+0xf4>
    kfree(np->kstack);
    np->kstack = 0;
    np->state = UNUSED;
    return -1;
...
80103960:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80103963:	89 01                	mov    %eax,(%ecx)
  np->parent = curproc;
80103965:	89 59 18             	mov    %ebx,0x18(%ecx)
  *np->tf = *curproc->tf;
80103968:	89 c8                	mov    %ecx,%eax
8010396a:	8b 79 1c             	mov    0x1c(%ecx),%edi
8010396d:	8b 73 1c             	mov    0x1c(%ebx),%esi
80103970:	b9 13 00 00 00       	mov    $0x13,%ecx
80103975:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;

  for(i = 0; i < NOFILE; i++)
80103977:	31 f6                	xor    %esi,%esi
  np->sz = curproc->sz;
  np->parent = curproc;
  *np->tf = *curproc->tf;
...
801039ae:	ff 73 6c             	pushl  0x6c(%ebx)

  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
801039b1:	83 c3 70             	add    $0x70,%ebx
  np->tf->eax = 0;
...
801039bc:	83 c4 0c             	add    $0xc,%esp
  ...
  for(i = 0; i < NOFILE; i++)
    if(curproc->ofile[i])
      np->ofile[i] = filedup(curproc->ofile[i]);
  np->cwd = idup(curproc->cwd);
801039bf:	89 47 6c             	mov    %eax,0x6c(%edi)

  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
801039c2:	8d 47 70             	lea    0x70(%edi),%eax
801039c5:	6a 10                	push   $0x10
801039c7:	53                   	push   %ebx
801039c8:	50                   	push   %eax
801039c9:	e8 32 0c 00 00       	call   80104600 <safestrcpy>

  pid = np->pid;
801039ce:	8b 5f 14             	mov    0x14(%edi),%ebx

  acquire(&ptable.lock);
801039d1:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801039d8:	e8 b3 08 00 00       	call   80104290 <acquire>

  np->state = RUNNABLE;
801039dd:	c7 47 10 03 00 00 00 	movl   $0x3,0x10(%edi)

  release(&ptable.lock);
801039e4:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801039eb:	e8 c0 09 00 00       	call   801043b0 <release>
...
80103a0a:	ff 77 0c             	pushl  0xc(%edi)
80103a0d:	e8 be e8 ff ff       	call   801022d0 <kfree>
    np->kstack = 0;
80103a12:	c7 47 0c 00 00 00 00 	movl   $0x0,0xc(%edi)
    np->state = UNUSED;
80103a19:	c7 47 10 00 00 00 00 	movl   $0x0,0x10(%edi)
    return -1;
...
80103a79:	74 45                	je     80103ac0 <scheduler+0x90>
      if(p->state != RUNNABLE)
80103a7b:	83 7b 10 03          	cmpl   $0x3,0x10(%ebx)
...
80103b1a:	75 68                	jne    80103b84 <sched+0xa4>
    panic("sched locks");
  if(p->state == RUNNING)
80103b1c:	83 7b 10 04          	cmpl   $0x4,0x10(%ebx)
...
80103b2e:	83 c3 20             	add    $0x20,%ebx
    panic("sched locks");
  if(p->state == RUNNING)
    panic("sched running");
  if(readeflags()&FL_IF)
...
80103b60:	68 f0 75 10 80       	push   $0x801075f0
...
80103b6d:	68 1c 76 10 80       	push   $0x8010761c
...
80103b7a:	68 0e 76 10 80       	push   $0x8010760e
...
80103b87:	68 02 76 10 80       	push   $0x80107602
...
80103bc4:	8d 5e 2c             	lea    0x2c(%esi),%ebx
80103bc7:	8d 7e 6c             	lea    0x6c(%esi),%edi
...
80103c17:	8b 56 18             	mov    0x18(%esi),%edx
...
80103c32:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
80103c36:	75 f0                	jne    80103c28 <exit+0x88>
80103c38:	3b 50 24             	cmp    0x24(%eax),%edx
80103c3b:	75 eb                	jne    80103c28 <exit+0x88>
      p->state = RUNNABLE;
80103c3d:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
static void
wakeup1(void *chan)
{
  struct proc *p;
...
80103c69:	74 33                	je     80103c9e <exit+0xfe>
    if(p->parent == curproc){
80103c6b:	39 72 18             	cmp    %esi,0x18(%edx)
80103c6e:	75 f0                	jne    80103c60 <exit+0xc0>
      p->parent = initproc;
      if(p->state == ZOMBIE)
80103c70:	83 7a 10 05          	cmpl   $0x5,0x10(%edx)
  wakeup1(curproc->parent);
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->parent == curproc){
      p->parent = initproc;
80103c74:	89 4a 18             	mov    %ecx,0x18(%edx)
      if(p->state == ZOMBIE)
...
80103c88:	74 d6                	je     80103c60 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan)
80103c8a:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
80103c8e:	75 f0                	jne    80103c80 <exit+0xe0>
80103c90:	3b 48 24             	cmp    0x24(%eax),%ecx
80103c93:	75 eb                	jne    80103c80 <exit+0xe0>
      p->state = RUNNABLE;
80103c95:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
...
80103c9e:	c7 46 10 05 00 00 00 	movl   $0x5,0x10(%esi)
  sched();
80103ca5:	e8 36 fe ff ff       	call   80103ae0 <sched>
  panic("zombie exit");
80103caa:	83 ec 0c             	sub    $0xc,%esp
80103cad:	68 3d 76 10 80       	push   $0x8010763d
...
80103cba:	68 30 76 10 80       	push   $0x80107630
...
80103cf6:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  sched();
...
80103d68:	e8 43 06 00 00       	call   801043b0 <release>
  ...
  // Go to sleep.
  p->chan = chan;
80103d6d:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
80103d70:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
...
80103d77:	e8 64 fd ff ff       	call   80103ae0 <sched>
  ...
  // Tidy up.
  p->chan = 0;
80103d7c:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
...
80103da1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  // Go to sleep.
  p->chan = chan;
80103da8:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
80103dab:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
...
80103db2:	e8 29 fd ff ff       	call   80103ae0 <sched>
  ...
  // Tidy up.
  p->chan = 0;
80103db7:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
...
80103dc9:	68 4f 76 10 80       	push   $0x8010764f
...
80103dd6:	68 49 76 10 80       	push   $0x80107649
...
80103e21:	74 1d                	je     80103e40 <wait+0x60>
      if(p->parent != curproc)
80103e23:	39 73 18             	cmp    %esi,0x18(%ebx)
80103e26:	75 f0                	jne    80103e18 <wait+0x38>
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
80103e28:	83 7b 10 05          	cmpl   $0x5,0x10(%ebx)
...
80103e44:	8b 46 28             	mov    0x28(%esi),%eax
...
80103e61:	ff 73 0c             	pushl  0xc(%ebx)
      if(p->parent != curproc)
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
        pid = p->pid;
80103e64:	8b 73 14             	mov    0x14(%ebx),%esi
        kfree(p->kstack);
80103e67:	e8 64 e4 ff ff       	call   801022d0 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
80103e6c:	5a                   	pop    %edx
80103e6d:	ff 73 08             	pushl  0x8(%ebx)
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
        pid = p->pid;
        kfree(p->kstack);
        p->kstack = 0;
80103e70:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        freevm(p->pgdir);
80103e77:	e8 94 2d 00 00       	call   80106c10 <freevm>
        p->pid = 0;
80103e7c:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->parent = 0;
80103e83:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
80103e8a:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
80103e8e:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
...
80103ef8:	74 1c                	je     80103f16 <wakeup+0x46>
    if(p->state == SLEEPING && p->chan == chan)
80103efa:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
80103efe:	75 f0                	jne    80103ef0 <wakeup+0x20>
80103f00:	3b 58 24             	cmp    0x24(%eax),%ebx
80103f03:	75 eb                	jne    80103ef0 <wakeup+0x20>
      p->state = RUNNABLE;
80103f05:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
static void
wakeup1(void *chan)
{
  struct proc *p;
...
80103f58:	74 3e                	je     80103f98 <kill+0x68>
    if(p->pid == pid){
80103f5a:	39 58 14             	cmp    %ebx,0x14(%eax)
80103f5d:	75 f1                	jne    80103f50 <kill+0x20>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80103f5f:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->pid == pid){
      p->killed = 1;
80103f63:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
...
80103f84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->pid == pid){
      ...
      if(p->state == SLEEPING)
        p->state = RUNNABLE;
80103f88:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
...
80103fc9:	bb c4 2d 11 80       	mov    $0x80112dc4,%ebx
...
80103fdb:	68 df 79 10 80       	push   $0x801079df
...
80103fe8:	83 eb 80             	sub    $0xffffff80,%ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103feb:	81 fb c4 4d 11 80    	cmp    $0x80114dc4,%ebx
...
80103ffe:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80104001:	ba 60 76 10 80       	mov    $0x80107660,%edx
  uint pc[10];
...
80104008:	8b 14 85 c0 76 10 80 	mov    -0x7fef8940(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
8010400f:	b8 60 76 10 80       	mov    $0x80107660,%eax
...
8010401e:	68 64 76 10 80       	push   $0x80107664
...
8010405d:	68 a1 70 10 80       	push   $0x801070a1
...
8010408a:	68 d8 76 10 80       	push   $0x801076d8
...
801040fe:	8b 40 14             	mov    0x14(%eax),%eax
...
80104333:	68 e3 76 10 80       	push   $0x801076e3
...
80104395:	68 02 77 10 80       	push   $0x80107702
...
801043a2:	68 eb 76 10 80       	push   $0x801076eb
...
801043c1:	68 09 77 10 80       	push   $0x80107709
...
8010467a:	e8 f1 f0 ff ff       	call   80103770 <myproc>
  ...
  if(addr <= curproc->se || addr-4 < curproc->se)// cs153
8010467f:	8b 40 04             	mov    0x4(%eax),%eax
80104682:	39 d8                	cmp    %ebx,%eax
80104684:	73 1a                	jae    801046a0 <fetchint+0x30>
80104686:	8d 53 fc             	lea    -0x4(%ebx),%edx
80104689:	39 d0                	cmp    %edx,%eax
8010468b:	77 13                	ja     801046a0 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
8010468d:	8b 45 0c             	mov    0xc(%ebp),%eax
80104690:	8b 13                	mov    (%ebx),%edx
80104692:	89 10                	mov    %edx,(%eax)
  return 0;
80104694:	31 c0                	xor    %eax,%eax
}
...
801046a5:	eb ef                	jmp    80104696 <fetchint+0x26>
...
801046c4:	73 31                	jae    801046f7 <fetchstr+0x47>
801046c6:	8d 53 fc             	lea    -0x4(%ebx),%edx
801046c9:	39 d0                	cmp    %edx,%eax
801046cb:	77 2a                	ja     801046f7 <fetchstr+0x47>
    return -1;
  *pp = (char*)addr;
801046cd:	8b 55 0c             	mov    0xc(%ebp),%edx
  ep = (char*)(PGROUNDDOWN(KERNBASE-4));// cs153
  for(s = *pp; s < ep; s++){
801046d0:	81 fb ff ef ff 7f    	cmp    $0x7fffefff,%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
  ...
  if(addr <= curproc->se || addr-4 < curproc->se)// cs153
    return -1;
  *pp = (char*)addr;
801046d6:	89 d8                	mov    %ebx,%eax
801046d8:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)(PGROUNDDOWN(KERNBASE-4));// cs153
  for(s = *pp; s < ep; s++){
801046da:	77 1b                	ja     801046f7 <fetchstr+0x47>
    if(*s == 0)
801046dc:	80 3b 00             	cmpb   $0x0,(%ebx)
801046df:	75 0c                	jne    801046ed <fetchstr+0x3d>
801046e1:	eb 25                	jmp    80104708 <fetchstr+0x58>
801046e3:	90                   	nop
801046e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801046e8:	80 38 00             	cmpb   $0x0,(%eax)
801046eb:	74 1b                	je     80104708 <fetchstr+0x58>
...
801046f0:	3d 00 f0 ff 7f       	cmp    $0x7ffff000,%eax
801046f5:	75 f1                	jne    801046e8 <fetchstr+0x38>
    if(*s == 0)
      return s - *pp;
  }
  return -1;
}
801046f7:	83 c4 04             	add    $0x4,%esp
{
  char *s, *ep;
  struct proc *curproc = myproc();
...
8010471a:	8b 40 1c             	mov    0x1c(%eax),%eax
...
fetchint(uint addr, int *ip)
{
  ...
  if(addr <= curproc->se || addr-4 < curproc->se)// cs153
80104731:	39 c6                	cmp    %eax,%esi
80104733:	76 1b                	jbe    80104750 <argint+0x40>
80104735:	39 c3                	cmp    %eax,%ebx
80104737:	72 17                	jb     80104750 <argint+0x40>
    return -1;
  *ip = *(int*)(addr);
80104739:	8b 45 0c             	mov    0xc(%ebp),%eax
8010473c:	8b 53 04             	mov    0x4(%ebx),%edx
...
80104755:	eb ec                	jmp    80104743 <argint+0x33>
...
80104771:	e8 9a ff ff ff       	call   80104710 <argint>
    return -1;
  if(size < 0 || (uint)i >= (PGROUNDDOWN(KERNBASE-4)) || (uint)i+size > (PGROUNDDOWN(KERNBASE-4)))// CS153
80104776:	c1 e8 1f             	shr    $0x1f,%eax
80104779:	83 c4 10             	add    $0x10,%esp
8010477c:	84 c0                	test   %al,%al
8010477e:	75 30                	jne    801047b0 <argptr+0x50>
80104780:	89 d8                	mov    %ebx,%eax
80104782:	c1 e8 1f             	shr    $0x1f,%eax
80104785:	84 c0                	test   %al,%al
80104787:	75 27                	jne    801047b0 <argptr+0x50>
80104789:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010478c:	3d ff ef ff 7f       	cmp    $0x7fffefff,%eax
80104791:	77 1d                	ja     801047b0 <argptr+0x50>
80104793:	01 c3                	add    %eax,%ebx
80104795:	81 fb 00 f0 ff 7f    	cmp    $0x7ffff000,%ebx
8010479b:	77 13                	ja     801047b0 <argptr+0x50>
    return -1;
  *pp = (char*)i;
8010479d:	8b 55 0c             	mov    0xc(%ebp),%edx
801047a0:	89 02                	mov    %eax,(%edx)
  return 0;
801047a2:	31 c0                	xor    %eax,%eax
}
...
801047b5:	eb ed                	jmp    801047a4 <argptr+0x44>
...
80104805:	e8 66 ef ff ff       	call   80103770 <myproc>
  ...
  num = curproc->tf->eax;
8010480a:	8b 70 1c             	mov    0x1c(%eax),%esi
...
8010481a:	8b 14 85 40 77 10 80 	mov    -0x7fef88c0(,%eax,4),%edx
...
80104838:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104839:	8d 43 70             	lea    0x70(%ebx),%eax
...
8010483d:	ff 73 14             	pushl  0x14(%ebx)
80104840:	68 11 77 10 80       	push   $0x80107711
80104845:	e8 16 be ff ff       	call   80100660 <cprintf>
            curproc->pid, curproc->name, num);
    curproc->tf->eax = -1;
8010484a:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
801049a4:	68 bc 77 10 80       	push   $0x801077bc
...
801049bc:	68 bb 77 10 80       	push   $0x801077bb
...
801049d1:	68 af 77 10 80       	push   $0x801077af
...
801049de:	68 be 77 10 80       	push   $0x801077be
...
801049eb:	68 a0 77 10 80       	push   $0x801077a0
...
80104a2c:	8b 44 90 2c          	mov    0x2c(%eax,%edx,4),%eax
...
80104a90:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
80104aac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd] == 0){
      curproc->ofile[fd] = f;
80104ab0:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
...
80104bcd:	83 ec 0c             	sub    $0xc,%esp
  ...
  if(argfd(0, &fd, &f) < 0)
    return -1;
  myproc()->ofile[fd] = 0;
80104bd0:	c7 44 90 2c 00 00 00 	movl   $0x0,0x2c(%eax,%edx,4)
80104bd7:	00 
  fileclose(f);
...
80104dfd:	58                   	pop    %eax
80104dfe:	5a                   	pop    %edx
80104dff:	68 bc 77 10 80       	push   $0x801077bc
...
80104e18:	68 bb 77 10 80       	push   $0x801077bb
...
80104f6d:	68 e0 77 10 80       	push   $0x801077e0
...
80104f7a:	68 f2 77 10 80       	push   $0x801077f2
...
80104f87:	68 ce 77 10 80       	push   $0x801077ce
...
801050a0:	83 ec 0c             	sub    $0xc,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd] == 0){
      curproc->ofile[fd] = f;
801050a3:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
801053be:	66 90                	xchg   %ax,%ax
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd] == 0){
801053c0:	8b 74 98 2c          	mov    0x2c(%eax,%ebx,4),%esi
...
801053fb:	89 7c b0 0c          	mov    %edi,0xc(%eax,%esi,4)
  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
    return -1;
  if(pipealloc(&rf, &wf) < 0)
    return -1;
...
80105409:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
80105410:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
...
80105425:	c7 44 b0 0c 00 00 00 	movl   $0x0,0xc(%eax,%esi,4)
8010542c:	00 
...
8010542f:	90                   	nop
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd] == 0){
      curproc->ofile[fd] = f;
80105430:	89 7c 90 2c          	mov    %edi,0x2c(%eax,%edx,4)
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
80105488:	e8 a3 1b 00 00       	call   80107030 <shm_open>
...
801054be:	e8 7d 1b 00 00       	call   80107040 <shm_close>
...
8010555b:	8b 40 14             	mov    0x14(%eax),%eax
}
8010555e:	c9                   	leave  
8010555f:	c3                   	ret    
...
80105616:	8b 40 28             	mov    0x28(%eax),%eax
...
80105709:	68 01 78 10 80       	push   $0x80107801
...
801057a0:	ff 24 85 a8 78 10 80 	jmp    *-0x7fef8758(,%eax,4)
...
801057fd:	53                   	push   %ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
801057fe:	83 c2 70             	add    $0x70,%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
...
80105802:	ff 70 14             	pushl  0x14(%eax)
80105805:	68 64 78 10 80       	push   $0x80107864
...
80105817:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
...
8010582e:	8b 50 28             	mov    0x28(%eax),%edx
...
80105843:	83 78 10 04          	cmpl   $0x4,0x10(%eax)
...
80105857:	8b 40 28             	mov    0x28(%eax),%eax
...
801058ef:	68 0c 78 10 80       	push   $0x8010780c
...
80105931:	89 78 1c             	mov    %edi,0x1c(%eax)
    syscall();
80105934:	e8 c7 ee ff ff       	call   80104800 <syscall>
    if(myproc()->killed)
...
80105968:	e8 23 e9 ff ff       	call   80104290 <acquire>
      ticks++;
      wakeup(&ticks);
...
801059a8:	68 30 78 10 80       	push   $0x80107830
801059ad:	e8 ae ac ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
801059b2:	83 c4 14             	add    $0x14,%esp
801059b5:	68 06 78 10 80       	push   $0x80107806
...
80105aaf:	bb 28 79 10 80       	mov    $0x80107928,%ebx
...
8010661a:	e8 e1 dd ff ff       	call   80104400 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801066a5:	e8 16 ff ff ff       	call   801065c0 <walkpgdir>
    if(!pte)
...
801066d2:	68 c6 72 10 80       	push   $0x801072c6
...
801066e3:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
801066e6:	e8 65 d0 ff ff       	call   80103750 <cpuid>
...
801067ec:	8b 55 10             	mov    0x10(%ebp),%edx
801067ef:	8b 7d 14             	mov    0x14(%ebp),%edi
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm)
{
  char *a, *last;
  pte_t *pte;
...
801067f2:	89 c3                	mov    %eax,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801067f4:	8d 44 10 ff          	lea    -0x1(%eax,%edx,1),%eax
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm)
{
  char *a, *last;
  pte_t *pte;
...
80106805:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
80106808:	8b 45 18             	mov    0x18(%ebp),%eax
8010680b:	83 c8 01             	or     $0x1,%eax
8010680e:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106811:	eb 1a                	jmp    8010682d <mappages+0x4d>
80106813:	90                   	nop
80106814:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
    if(*pte & PTE_P)
80106818:	f6 00 01             	testb  $0x1,(%eax)
8010681b:	75 3d                	jne    8010685a <mappages+0x7a>
      panic("remap");
    *pte = pa | perm | PTE_P;
8010681d:	0b 75 e0             	or     -0x20(%ebp),%esi
    if(a == last)
80106820:	3b 5d e4             	cmp    -0x1c(%ebp),%ebx
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
80106823:	89 30                	mov    %esi,(%eax)
    if(a == last)
80106825:	74 29                	je     80106850 <mappages+0x70>
      break;
    a += PGSIZE;
...
80106830:	b9 01 00 00 00       	mov    $0x1,%ecx
80106835:	89 da                	mov    %ebx,%edx
80106837:	8d 34 3b             	lea    (%ebx,%edi,1),%esi
8010683a:	e8 81 fd ff ff       	call   801065c0 <walkpgdir>
8010683f:	85 c0                	test   %eax,%eax
80106841:	75 d5                	jne    80106818 <mappages+0x38>
      break;
    a += PGSIZE;
    pa += PGSIZE;
  }
...
8010685d:	68 30 79 10 80       	push   $0x80107930
...
8010693d:	8b 56 0c             	mov    0xc(%esi),%edx
...
{
  asm volatile("movl %0,%%cr3" : : "r" (val));
8010695a:	8b 46 08             	mov    0x8(%esi),%eax
...
80106974:	68 36 79 10 80       	push   $0x80107936
...
80106981:	68 61 79 10 80       	push   $0x80107961
...
8010698e:	68 4c 79 10 80       	push   $0x8010794c
...
801069b8:	77 50                	ja     80106a0a <inituvm+0x6a>
801069ba:	89 55 e4             	mov    %edx,-0x1c(%ebp)
...
801069cf:	e8 2c da ff ff       	call   80104400 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
801069d4:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801069d7:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801069dd:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
801069e4:	50                   	push   %eax
801069e5:	68 00 10 00 00       	push   $0x1000
801069ea:	6a 00                	push   $0x0
801069ec:	52                   	push   %edx
801069ed:	e8 ee fd ff ff       	call   801067e0 <mappages>
  memmove(mem, init, sz);
801069f2:	89 75 10             	mov    %esi,0x10(%ebp)
801069f5:	89 7d 0c             	mov    %edi,0xc(%ebp)
...
80106a04:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106a05:	e9 a6 da ff ff       	jmp    801044b0 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106a0d:	68 75 79 10 80       	push   $0x80107975
...
80106abd:	68 8f 79 10 80       	push   $0x8010798f
...
80106aca:	68 30 7a 10 80       	push   $0x80107a30
...
80106af7:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  if(newsz >= KERNBASE)
    return 0;
  if(newsz < oldsz)
80106afa:	0f 82 84 00 00 00    	jb     80106b84 <allocuvm+0xa4>
    return oldsz;
...
80106b0e:	77 45                	ja     80106b55 <allocuvm+0x75>
...
80106b23:	e8 d8 d8 ff ff       	call   80104400 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106b28:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106b2e:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80106b35:	50                   	push   %eax
80106b36:	68 00 10 00 00       	push   $0x1000
80106b3b:	53                   	push   %ebx
80106b3c:	ff 75 08             	pushl  0x8(%ebp)
80106b3f:	e8 9c fc ff ff       	call   801067e0 <mappages>
80106b44:	83 c4 20             	add    $0x20,%esp
80106b47:	85 c0                	test   %eax,%eax
80106b49:	78 45                	js     80106b90 <allocuvm+0xb0>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80106b51:	39 df                	cmp    %ebx,%edi
80106b53:	76 7b                	jbe    80106bd0 <allocuvm+0xf0>
    mem = kalloc();
80106b55:	e8 26 b9 ff ff       	call   80102480 <kalloc>
    if(mem == 0){
...
80106b5c:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106b5e:	75 b8                	jne    80106b18 <allocuvm+0x38>
      cprintf("allocuvm out of memory\n");
80106b60:	83 ec 0c             	sub    $0xc,%esp
80106b63:	68 ad 79 10 80       	push   $0x801079ad
...
80106b73:	76 49                	jbe    80106bbe <allocuvm+0xde>
80106b75:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106b78:	8b 45 08             	mov    0x8(%ebp),%eax
80106b7b:	89 fa                	mov    %edi,%edx
80106b7d:	e8 be fa ff ff       	call   80106640 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
80106b93:	68 c5 79 10 80       	push   $0x801079c5
...
80106bad:	e8 8e fa ff ff       	call   80106640 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
80106bf0:	5d                   	pop    %ebp
80106bf1:	e9 4a fa ff ff       	jmp    80106640 <deallocuvm.part.0>
...
80106c29:	e8 12 fa ff ff       	call   80106640 <deallocuvm.part.0>
...
80106c7c:	68 e1 79 10 80       	push   $0x801079e1
...
80106cb0:	e8 4b d7 ff ff       	call   80104400 <memset>
...
80106cbb:	8b 53 08             	mov    0x8(%ebx),%edx
80106cbe:	83 ec 0c             	sub    $0xc,%esp
80106cc1:	ff 73 0c             	pushl  0xc(%ebx)
80106cc4:	29 c2                	sub    %eax,%edx
80106cc6:	50                   	push   %eax
80106cc7:	52                   	push   %edx
80106cc8:	ff 33                	pushl  (%ebx)
80106cca:	56                   	push   %esi
80106ccb:	e8 10 fb ff ff       	call   801067e0 <mappages>
...
80106d4f:	68 f2 79 10 80       	push   $0x801079f2
...
// of it for a child.
pde_t*
copyuvm(pde_t *pgdir, uint sz, uint se)// cs153
{
...
80106d73:	0f 84 4d 01 00 00    	je     80106ec6 <copyuvm+0x166>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106d79:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106d7c:	85 c9                	test   %ecx,%ecx
80106d7e:	0f 84 a4 00 00 00    	je     80106e28 <copyuvm+0xc8>
80106d84:	31 f6                	xor    %esi,%esi
80106d86:	eb 48                	jmp    80106dd0 <copyuvm+0x70>
80106d88:	90                   	nop
...
80106da0:	e8 0b d7 ff ff       	call   801044b0 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106da5:	5a                   	pop    %edx
80106da6:	8d 93 00 00 00 80    	lea    -0x80000000(%ebx),%edx
80106dac:	ff 75 e4             	pushl  -0x1c(%ebp)
80106daf:	52                   	push   %edx
80106db0:	68 00 10 00 00       	push   $0x1000
80106db5:	56                   	push   %esi
80106db6:	ff 75 e0             	pushl  -0x20(%ebp)
80106db9:	e8 22 fa ff ff       	call   801067e0 <mappages>
80106dbe:	83 c4 20             	add    $0x20,%esp
80106dc1:	85 c0                	test   %eax,%eax
80106dc3:	78 46                	js     80106e0b <copyuvm+0xab>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106dc5:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106dcb:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106dce:	76 58                	jbe    80106e28 <copyuvm+0xc8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106dd0:	8b 45 08             	mov    0x8(%ebp),%eax
80106dd3:	31 c9                	xor    %ecx,%ecx
80106dd5:	89 f2                	mov    %esi,%edx
80106dd7:	e8 e4 f7 ff ff       	call   801065c0 <walkpgdir>
80106ddc:	85 c0                	test   %eax,%eax
80106dde:	0f 84 f6 00 00 00    	je     80106eda <copyuvm+0x17a>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106de4:	8b 18                	mov    (%eax),%ebx
80106de6:	f6 c3 01             	test   $0x1,%bl
80106de9:	0f 84 de 00 00 00    	je     80106ecd <copyuvm+0x16d>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106def:	89 df                	mov    %ebx,%edi
    flags = PTE_FLAGS(*pte);
80106df1:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
80106df7:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106dfa:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106e00:	e8 7b b6 ff ff       	call   80102480 <kalloc>
80106e05:	85 c0                	test   %eax,%eax
80106e07:	89 c3                	mov    %eax,%ebx
80106e09:	75 85                	jne    80106d90 <copyuvm+0x30>
  }
...
80106e0e:	ff 75 e0             	pushl  -0x20(%ebp)
80106e11:	e8 fa fd ff ff       	call   80106c10 <freevm>
  return 0;
80106e16:	83 c4 10             	add    $0x10,%esp
80106e19:	31 c0                	xor    %eax,%eax
}
...
80106e24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(i = se; i < PGROUNDDOWN(KERNBASE-4); i += PGSIZE){// Loop over stack cs153
80106e28:	81 7d 10 ff ef ff 7f 	cmpl   $0x7fffefff,0x10(%ebp)
80106e2f:	0f 87 86 00 00 00    	ja     80106ebb <copyuvm+0x15b>
80106e35:	8b 75 10             	mov    0x10(%ebp),%esi
80106e38:	eb 49                	jmp    80106e83 <copyuvm+0x123>
...
80106e50:	e8 5b d6 ff ff       	call   801044b0 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106e55:	58                   	pop    %eax
...
80106e69:	e8 72 f9 ff ff       	call   801067e0 <mappages>
80106e6e:	83 c4 20             	add    $0x20,%esp
80106e71:	85 c0                	test   %eax,%eax
80106e73:	78 96                	js     80106e0b <copyuvm+0xab>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
      goto bad;
...
80106e7b:	81 fe ff ef ff 7f    	cmp    $0x7fffefff,%esi
80106e81:	77 38                	ja     80106ebb <copyuvm+0x15b>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106e83:	8b 45 08             	mov    0x8(%ebp),%eax
80106e86:	31 c9                	xor    %ecx,%ecx
80106e88:	89 f2                	mov    %esi,%edx
80106e8a:	e8 31 f7 ff ff       	call   801065c0 <walkpgdir>
80106e8f:	85 c0                	test   %eax,%eax
80106e91:	74 47                	je     80106eda <copyuvm+0x17a>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106e93:	8b 18                	mov    (%eax),%ebx
80106e95:	f6 c3 01             	test   $0x1,%bl
80106e98:	74 33                	je     80106ecd <copyuvm+0x16d>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106e9a:	89 df                	mov    %ebx,%edi
    flags = PTE_FLAGS(*pte);
80106e9c:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
80106ea2:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
  for(i = se; i < PGROUNDDOWN(KERNBASE-4); i += PGSIZE){// Loop over stack cs153
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
...
80106ea5:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106eab:	e8 d0 b5 ff ff       	call   80102480 <kalloc>
80106eb0:	85 c0                	test   %eax,%eax
80106eb2:	89 c3                	mov    %eax,%ebx
80106eb4:	75 8a                	jne    80106e40 <copyuvm+0xe0>
80106eb6:	e9 50 ff ff ff       	jmp    80106e0b <copyuvm+0xab>
...
80106ec5:	c3                   	ret    
  ...
  if((d = setupkvm()) == 0)
    return 0;
80106ec6:	31 c0                	xor    %eax,%eax
80106ec8:	e9 4e ff ff ff       	jmp    80106e1b <copyuvm+0xbb>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
...
80106ed0:	68 16 7a 10 80       	push   $0x80107a16
80106ed5:	e8 96 94 ff ff       	call   80100370 <panic>
...
80106edd:	68 fc 79 10 80       	push   $0x801079fc
...
80106efe:	e8 bd f6 ff ff       	call   801065c0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106f6f:	e8 3c d5 ff ff       	call   801044b0 <memmove>
    len -= n;
    buf += n;
...
80106fd3:	83 ec 10             	sub    $0x10,%esp
  int i;
  initlock(&(shm_table.lock), "SHM lock");
80106fd6:	68 54 7a 10 80       	push   $0x80107a54
80106fdb:	68 c0 55 11 80       	push   $0x801155c0
80106fe0:	e8 ab d1 ff ff       	call   80104190 <initlock>
  acquire(&(shm_table.lock));
80106fe5:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106fec:	e8 9f d2 ff ff       	call   80104290 <acquire>
80106ff1:	b8 f4 55 11 80       	mov    $0x801155f4,%eax
...
8010700d:	83 c0 0c             	add    $0xc,%eax
    shm_table.shm_pages[i].refcnt =0;
80107010:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
...
void shminit() {
  ...
  acquire(&(shm_table.lock));
  for (i = 0; i< 64; i++) {
80107017:	3d f4 58 11 80       	cmp    $0x801158f4,%eax
8010701c:	75 e2                	jne    80107000 <shminit+0x30>
    shm_table.shm_pages[i].id =0;
    shm_table.shm_pages[i].frame =0;
    shm_table.shm_pages[i].refcnt =0;
  }
...
80107021:	68 c0 55 11 80       	push   $0x801155c0
80107026:	e8 85 d3 ff ff       	call   801043b0 <release>
}
