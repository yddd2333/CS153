...
80106fa9:	8b 75 08             	mov    0x8(%ebp),%esi
	...
	uint a;
	struct proc *curproc = myproc();
80106fac:	e8 cf c7 ff ff       	call   80103780 <myproc>

	initlock(&(shm_table.lock), "SHM lock");
80106fb1:	83 ec 08             	sub    $0x8,%esp
...
80106fb4:	89 c7                	mov    %eax,%edi
	...
	initlock(&(shm_table.lock), "SHM lock");
80106fb6:	68 74 7b 10 80       	push   $0x80107b74
80106fbb:	68 c0 54 11 80       	push   $0x801154c0
80106fc0:	e8 db d1 ff ff       	call   801041a0 <initlock>
	acquire(&(shm_table.lock));
80106fc5:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106fcc:	e8 cf d2 ff ff       	call   801042a0 <acquire>
80106fd1:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
...
80106fdd:	eb 0c                	jmp    80106feb <shm_open+0x4b>
80106fdf:	90                   	nop

	for (i = 0; i<64; i++) {
80106fe0:	83 c1 01             	add    $0x1,%ecx
80106fe3:	83 c3 0c             	add    $0xc,%ebx
80106fe6:	83 f9 40             	cmp    $0x40,%ecx
80106fe9:	74 65                	je     80107050 <shm_open+0xb0>
		if (id == shm_table.shm_pages[i].id) {
80106feb:	3b 33                	cmp    (%ebx),%esi
80106fed:	75 f1                	jne    80106fe0 <shm_open+0x40>
	
	a = PGROUNDUP(curproc->sz);
	
	if (exist == 1) {
		
		mappages(curproc->pgdir, (void *)a, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U);
80106fef:	8b 07                	mov    (%edi),%eax
80106ff1:	83 ec 0c             	sub    $0xc,%esp
80106ff4:	6a 06                	push   $0x6
80106ff6:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106ffc:	8d 04 49             	lea    (%ecx,%ecx,2),%eax
80106fff:	8d 34 85 c0 54 11 80 	lea    -0x7feeab40(,%eax,4),%esi
80107006:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
8010700c:	8b 46 38             	mov    0x38(%esi),%eax
8010700f:	05 00 00 00 80       	add    $0x80000000,%eax
80107014:	50                   	push   %eax
80107015:	68 00 10 00 00       	push   $0x1000
8010701a:	53                   	push   %ebx
8010701b:	ff 77 04             	pushl  0x4(%edi)
8010701e:	e8 cd f7 ff ff       	call   801067f0 <mappages>
...
80107023:	8b 45 0c             	mov    0xc(%ebp),%eax
	...
	if (exist == 1) {
		...
		mappages(curproc->pgdir, (void *)a, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U);
		shm_table.shm_pages[i].refcnt += 1;
80107026:	83 46 3c 01          	addl   $0x1,0x3c(%esi)
8010702a:	83 c4 20             	add    $0x20,%esp
		*pointer = (char *)a;
8010702d:	89 18                	mov    %ebx,(%eax)
		curproc->sz += PGSIZE;
8010702f:	81 07 00 10 00 00    	addl   $0x1000,(%edi)
		mappages(curproc->pgdir, (void *)a, PGSIZE, V2P(mem), PTE_W|PTE_U);
		*pointer = (char *)a;
		curproc->sz += PGSIZE;		
	}
...
80107038:	68 c0 54 11 80       	push   $0x801154c0
8010703d:	e8 7e d3 ff ff       	call   801043c0 <release>
//you write this
return 0; //added to remove compiler warning -- you should decide what to return
}
80107042:	8d 65 f4             	lea    -0xc(%ebp),%esp
80107045:	31 c0                	xor    %eax,%eax
80107047:	5b                   	pop    %ebx
80107048:	5e                   	pop    %esi
80107049:	5f                   	pop    %edi
8010704a:	5d                   	pop    %ebp
...
8010704c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	...
	a = PGROUNDUP(curproc->sz);
80107050:	8b 17                	mov    (%edi),%edx
80107052:	31 db                	xor    %ebx,%ebx
80107054:	81 c2 ff 0f 00 00    	add    $0xfff,%edx
8010705a:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80107060:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80107063:	eb 0e                	jmp    80107073 <shm_open+0xd3>
80107065:	8d 76 00             	lea    0x0(%esi),%esi
		...
		*pointer = (char *)a;
		...
		for (j = 0; j<64; j++) {
80107068:	83 c3 01             	add    $0x1,%ebx
8010706b:	83 c0 0c             	add    $0xc,%eax
8010706e:	83 fb 40             	cmp    $0x40,%ebx
80107071:	74 06                	je     80107079 <shm_open+0xd9>
			if (shm_table.shm_pages[j].id == 0) {
80107073:	8b 10                	mov    (%eax),%edx
80107075:	85 d2                	test   %edx,%edx
80107077:	75 ef                	jne    80107068 <shm_open+0xc8>
				break;
			}
		}
		char *mem = kalloc();
80107079:	e8 12 b4 ff ff       	call   80102490 <kalloc>
		memset(mem, 0, PGSIZE);
8010707e:	83 ec 04             	sub    $0x4,%esp
80107081:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107084:	68 00 10 00 00       	push   $0x1000
80107089:	6a 00                	push   $0x0
8010708b:	50                   	push   %eax
8010708c:	e8 7f d3 ff ff       	call   80104410 <memset>
		shm_table.shm_pages[j].id = id;
80107091:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
		shm_table.shm_pages[j].frame = mem;
80107094:	8b 4d e0             	mov    -0x20(%ebp),%ecx
				break;
			}
		}
		char *mem = kalloc();
		memset(mem, 0, PGSIZE);
		shm_table.shm_pages[j].id = id;
80107097:	8d 04 85 c0 54 11 80 	lea    -0x7feeab40(,%eax,4),%eax
8010709e:	89 70 34             	mov    %esi,0x34(%eax)
		shm_table.shm_pages[j].frame = mem;
		shm_table.shm_pages[j].refcnt = 1;
		mappages(curproc->pgdir, (void *)a, PGSIZE, V2P(mem), PTE_W|PTE_U);
801070a1:	8b 75 e4             	mov    -0x1c(%ebp),%esi
			}
		}
		char *mem = kalloc();
		memset(mem, 0, PGSIZE);
		shm_table.shm_pages[j].id = id;
		shm_table.shm_pages[j].frame = mem;
801070a4:	89 48 38             	mov    %ecx,0x38(%eax)
		shm_table.shm_pages[j].refcnt = 1;
		mappages(curproc->pgdir, (void *)a, PGSIZE, V2P(mem), PTE_W|PTE_U);
801070a7:	81 c1 00 00 00 80    	add    $0x80000000,%ecx
		}
		char *mem = kalloc();
		memset(mem, 0, PGSIZE);
		shm_table.shm_pages[j].id = id;
		shm_table.shm_pages[j].frame = mem;
		shm_table.shm_pages[j].refcnt = 1;
801070ad:	c7 40 3c 01 00 00 00 	movl   $0x1,0x3c(%eax)
		mappages(curproc->pgdir, (void *)a, PGSIZE, V2P(mem), PTE_W|PTE_U);
801070b4:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
801070bb:	51                   	push   %ecx
801070bc:	68 00 10 00 00       	push   $0x1000
801070c1:	56                   	push   %esi
801070c2:	ff 77 04             	pushl  0x4(%edi)
801070c5:	e8 26 f7 ff ff       	call   801067f0 <mappages>
		*pointer = (char *)a;
801070ca:	8b 55 0c             	mov    0xc(%ebp),%edx
		curproc->sz += PGSIZE;		
801070cd:	83 c4 20             	add    $0x20,%esp
		memset(mem, 0, PGSIZE);
		shm_table.shm_pages[j].id = id;
		shm_table.shm_pages[j].frame = mem;
		shm_table.shm_pages[j].refcnt = 1;
		mappages(curproc->pgdir, (void *)a, PGSIZE, V2P(mem), PTE_W|PTE_U);
		*pointer = (char *)a;
801070d0:	89 32                	mov    %esi,(%edx)
		curproc->sz += PGSIZE;		
801070d2:	81 07 00 10 00 00    	addl   $0x1000,(%edi)
801070d8:	e9 58 ff ff ff       	jmp    80107035 <shm_open+0x95>
...
801070e7:	8b 5d 08             	mov    0x8(%ebp),%ebx
	...
	initlock(&(shm_table.lock), "SHM lock");
801070ea:	68 74 7b 10 80       	push   $0x80107b74
801070ef:	68 c0 54 11 80       	push   $0x801154c0
801070f4:	e8 a7 d0 ff ff       	call   801041a0 <initlock>
	acquire(&(shm_table.lock));
801070f9:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80107100:	e8 9b d1 ff ff       	call   801042a0 <acquire>
80107105:	ba f4 54 11 80       	mov    $0x801154f4,%edx
8010710a:	83 c4 10             	add    $0x10,%esp

	for (i = 0; i<64; i++) {
8010710d:	31 c0                	xor    %eax,%eax
8010710f:	eb 12                	jmp    80107123 <shm_close+0x43>
80107111:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80107118:	83 c0 01             	add    $0x1,%eax
8010711b:	83 c2 0c             	add    $0xc,%edx
8010711e:	83 f8 40             	cmp    $0x40,%eax
80107121:	74 3d                	je     80107160 <shm_close+0x80>
		if (id == shm_table.shm_pages[i].id) {
80107123:	39 1a                	cmp    %ebx,(%edx)
80107125:	75 f1                	jne    80107118 <shm_close+0x38>
			exist = 1;
			break;
		}
	}
	if (exist == 1) {
		shm_table.shm_pages[i].refcnt -= 1;
80107127:	8d 04 40             	lea    (%eax,%eax,2),%eax
8010712a:	8d 14 85 c0 54 11 80 	lea    -0x7feeab40(,%eax,4),%edx
		if (shm_table.shm_pages[i].refcnt == 0) {
80107131:	83 6a 3c 01          	subl   $0x1,0x3c(%edx)
80107135:	75 0e                	jne    80107145 <shm_close+0x65>
			shm_table.shm_pages[i].id =0;
80107137:	c7 42 34 00 00 00 00 	movl   $0x0,0x34(%edx)
			shm_table.shm_pages[i].frame =0;
8010713e:	c7 42 38 00 00 00 00 	movl   $0x0,0x38(%edx)
	} else {
...
80107148:	68 c0 54 11 80       	push   $0x801154c0
8010714d:	e8 6e d2 ff ff       	call   801043c0 <release>
//you write this too!
return 0; //added to remove compiler warning -- you should decide what to return
}
80107152:	31 c0                	xor    %eax,%eax
80107154:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80107157:	c9                   	leave  
80107158:	c3                   	ret    
...
80107163:	68 7d 7b 10 80       	push   $0x80107b7d
80107168:	e8 03 92 ff ff       	call   80100370 <panic>
